...
func TestReadNormalNoteOff(t *testing.T) {
	...
	tests := []*readTest{
		...
		mkTest(channel.Ch9.NoteOffVelocity(120, 64), "channel.NoteOff channel 9 key 120"),
	}
...
func TestRead(t *testing.T) {
	...
	tests := []*readTest{
		...
		mkTest(channel.Ch8.ChannelPressure(30), "channel.AfterTouch (\"ChannelPressure\") channel 8 pressure 30"),
		...
		mkTest(channel.Ch0.Portamento(123), "channel.PitchBend (\"Portamento\") channel 0 value 123 absValue 8315"),
		...
		mkTest(channel.Ch15.KeyPressure(120, 106), "channel.PolyphonicAfterTouch (\"KeyPressure\") channel 15 key 120 pressure 106"),
	}
